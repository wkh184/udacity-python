...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        # check for dogs
        if results_dic[key][3] == 1: #label dog
            results_stats_dic['n_dogs_img'] += 1
            if results_dic[key][4] == 1: #classifier dog
                results_stats_dic['n_correct_dogs'] += 1
            if results_dic[key][2] == 1: #match correct dog breed
                 results_stats_dic['n_correct_breed'] += 1
               
        else: # label not dog
            results_stats_dic['n_notdogs_img'] += 1
            if results_dic[key][4] == 0: #classifier not dog
...
#            pct_correct_notdogs - percentage of correctly classified NON-dogs
    ...
    print("Number of non dog match = {}".format(results_stats_dic['n_correct_notdogs']))
    print("Number of dog match = {}".format(results_stats_dic['n_correct_dogs']))
    print("Number of breed match = {}".format(results_stats_dic['n_correct_breed']))
