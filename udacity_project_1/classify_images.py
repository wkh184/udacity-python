...
def classify_images(images_dir, results_dic, model):
    ...
    """
    # Retrieve the filenames from folder images_dir
    print("images_dir = {}".format(images_dir))
    filename_list = get_filenames(images_dir)
    print("len(filename_list) = {}".format(len(filename_list)))
    ...
    for idx in range (0, len(filename_list), 1):
        ...
        full_filename = images_dir + "/" + filename_list[idx]
        image_classification = classifier(full_filename, model)
        # Sets string to lower case letters
        low_classification = image_classification.lower()
        image_label = results_dic[filename_list[idx]][0]
        #print("low_classification = {}".format(low_classification))
        ...
        results_dic[filename_list[idx]].append(low_classification)
        if image_label in low_classification:
